...
export const ERROR_MESSAGES = {
  ...
  NO_PERSONAS_GENERATED: 'ペルソナが生成されませんでした。異なるキーワードで再試行してください。',
  
  // サーバーエラー
  SERVER_ERROR: 'サーバーエラーが発生しました',
  API_TIMEOUT: 'Dify APIリクエストがタイムアウトしました',
  API_AUTH_FAILED: 'Dify APIの認証に失敗しました。API設定を確認してください。',
  API_WORKFLOW_NOT_FOUND: 'Difyワークフローが見つかりません。設定を確認してください。',
  API_WORKFLOW_CONFIG_ERROR: 'Difyワークフローの設定に問題があります。管理者に連絡してください。',
...
export const SUCCESS_MESSAGES = {
  ...
  CANVAS_COMPLETION_MESSAGE: 'AIとの協力により、あなたのビジネスアイデアが具体的なリーンキャンバスとして形になりました。',
  NEXT_STEPS_MESSAGE: 'このキャンバスを基に、さらなるビジネス展開を検討してみてください。',
} as const;
...
export const HINTS = {
  ...
  BUSINESS_IDEA_HINT: 'ペルソナの課題やニーズに最も適したアイデアを選んでください',
...
export const TUTORIAL_MESSAGES = {
  ...
  NAVIGATION_HINT: 'リセットボタンで最初からやり直したり、テーマ切り替えボタンでダークモードを楽しんだりできます。いつでもこのチュートリアルを再表示することも可能です。',
} as const;
