...
export function StepProductNameSelection() {
  ...
  const handleNext = useCallback(() => {
    if (!selectedProductName || !selectedPersona || !selectedBusinessIdea || isPending) {
  ...
  }, [selectedProductName, selectedPersona, selectedBusinessIdea, isPending, setError, setLeanCanvasData, goToNextStep]);
