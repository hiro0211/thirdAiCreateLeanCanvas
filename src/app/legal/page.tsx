...
export default function LegalPage() {
  const legalData = [
    ...
    },
    {
      label: "価格",
      value:
        "本サービスは、ユーザーが感じた価値に応じて価格を決める『Pay What You Want (PWYW)』方式を採用しております。お支払いは、サービスの利用に対する正当な対価となります。必須ではございませんが、サービスの継続的な開発・運営のため、ご協力いただけますと幸いです。",
    },
    {
      label: "商品代金以外の必要料金",
      value: "なし",
    ...
    },
    {
      label: "決済時期",
      value:
        "クレジットカード決済の場合、カード情報入力完了時に決済処理が行われます。",
    },
    {
      label: "配達時間",
      value:
        "本サービスはWebアプリケーションのため、お支払いの有無にかかわらず、サイトにアクセスいただくことで常時ご利用可能です。決済完了による機能の追加や変更はございません。",
    },
    {
      label: "サービスの提供時期",
      value: "本サービスは決済完了と同時にご利用いただけます。",
    },
    {
      label: "交換および返品に関するポリシー",
      value:
        "＜お客様からの返品・交換＞\nサービスの性質上、決済完了後のキャンセル・返金は原則としてお受けできません。\n\n＜不良品・サービスの返品・交換＞\nサービスに技術的な問題が発生した場合は、連絡先メールアドレスまでお問い合わせください。迅速に対応いたします。",
    },
  ];
